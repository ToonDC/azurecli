...
Set-AzureDeployment -Upgrade -ServiceName $serviceName -Package $servicePackageFile -Configuration $serviceConfigFile -Slot $slot -ExtensionConfiguration $diagnosticExtensions